...
make_branch_pr() {
  ...
  echo "tx pull --all --branch $branch --force --skip --minimum-perc=1 --mode $pull_mode --workers 4"
  tx pull --all --branch $branch --force --skip --minimum-perc=1 --mode $pull_mode --workers 4
